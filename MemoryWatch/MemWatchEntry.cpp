...
MemWatchEntry::MemWatchEntry(const u32 consoleAddress,
                             const Common::MemType type, const Common::MemBase base,
                             const bool isUnsigned, const size_t length,
                             const bool isBoundToPointer)
    : m_consoleAddress(consoleAddress), m_type(type), m_isUnsigned(isUnsigned),
...
MemWatchEntry::MemWatchEntry(MemWatchEntry *entry)
    : m_consoleAddress(entry->m_consoleAddress), m_type(entry->m_type),
